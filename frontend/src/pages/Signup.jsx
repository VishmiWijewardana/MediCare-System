...
import signimg from "../assest/images/R.gif";
import avatar from "../assest/images/OIP (3).jpg";
    ...
    <section className="px-5 xl:px-0">
      <div className="max-w-[1170px] mx-auto">
        <div className="grid grid-cols-1 lg:grid-cols-2">
          {/*=========img box======*/}
          <div className="hidden lg:block py-20  rounded-l-lg">
              ...
              <div className="mb-5 flex items-center justify-between">
                ...
                >
                  ...
                  <select
                    ...
                    value={formdata.role}
                  onChange={handleInputChange}
                    className="text-textColor font-semibold text-[15px] leading-7 px-4 py-3 fouces:outline-none"
                  >
